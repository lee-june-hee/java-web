...
// ── 챔피언 데이터 ──────────────────────────────────────────────
const CHAMPIONS = [
    { name: '아트록스', engName: 'Aatrox', role: '전사', lane: '탑', img: 'image/atrox images.jpg', difficulty: '중' },
    { name: '사일러스', engName: 'Sylas', role: '마법사', lane: '정글/미드', img: 'image/sylas images.jpg', difficulty: '중' },
    { name: '애니비아', engName: 'Anivia', role: '마법사', lane: '미드', img: 'image/anivia images.jpg', difficulty: '상' },
    { name: '브라이어', engName: 'Briar', role: '전사', lane: '정글', img: 'image/briar images.jpg', difficulty: '하' },
    { name: '잭스', engName: 'Jax', role: '전사', lane: '탑', img: 'image/Jax images.jpg', difficulty: '중' },
    { name: '징크스', engName: 'Jinx', role: '원거리딜러', lane: '원딜', img: 'image/Jinx images.jpg', difficulty: '중' },
];
